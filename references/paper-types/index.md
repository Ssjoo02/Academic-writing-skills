...
| Dataset/resource paper | `dataset-resource-paper.md` | A resource enables new measurement, training, or analysis. |
| Analysis paper | `analysis-paper.md` | A careful study explains a phenomenon or failure mode. |
| Position paper | `position-paper.md` | A reasoned argument reframes a problem or agenda. |
